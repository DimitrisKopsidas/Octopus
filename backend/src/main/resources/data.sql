...
INSERT INTO COURSES(ID,NAME,SEMESTER, QUESTION_SET_SIZE) VALUES
(1101, 'Μαθηματικά Ι', 1, 3),
(1102, 'Δομημένος Προγραμματισμός', 1, 10),
(1103, 'Εισαγωγή στην Επιστήμη των Υπολογιστών', 1, 10),
(1104, 'Ηλεκτρονική Φυσική', 1, 10),
(1105, 'Κυκλώματα Συνεχούς Ρεύματος', 1, 10),
(1201, 'Μαθηματικά ΙΙ', 2, 10),
(1202, 'Μετρήσεις και Κυκλώματα Εναλλασσόμενου Ρεύματος', 2, 10),
(1203, 'Τεχνική Συγγραφή, Παρουσίαση και Ορολογία Ξένης Γλώσσας', 2, 10),
(1204, 'Σχεδίαση Ψηφιακών Συστημάτων', 2, 10),
(1205, 'Αντικειμενοστρεφής Προγραμματισμός', 2, 10),

(1302, 'Μαθηματικά ΙΙI', 3, 10),
(1303, 'Επεξεργασία Σήματος', 3, 10),
(1301, 'Θεωρία Πιθανοτήτων και Στατιστική', 3, 10),
(1305, 'Δομές Δεδομένων και Ανάλυση Αλγορίθμων', 3, 10),
(1405, 'Γλώσσες και Τεχνολογίες Ιστού', 3, 10),

(1304, 'Οργάνωση και Αρχιτεκτονική Υπολογιστικών Συστημάτων', 4, 10),
(1401, 'Συστήματα Διαχείρισης Βάσεων Δεδομένων', 4, 10),
(1402, 'Τηλεπικοινωνιακά Συστήματα', 4, 10),
(1403, 'Εισαγωγή στα Λειτουργικά Συστήματα', 4, 10),
(1404, 'Ηλεκτρονικά Κυκλώματα', 4, 10),

(1501, 'Ασύρματες Επικοινωνίες', 5, 10),
(1503, 'Σχεδίαση Λειτουργικών Συστημάτων', 5, 10),
(1504, 'Ηλεκτρονικές Διατάξεις', 5, 10),
(1505, 'Αλληλεπίδραση Ανθρώπου-Μηχανής', 5, 10),
(1502, 'Μικροελεγκτές', 5, 10),

(1601, 'Τεχνητή Νοημοσύνη', 6, 10),
(1602, 'Ενσωματωμένα Συστήματα', 6, 10),
(1611, 'Σύνθεση Ηλεκτρονικών Κυκλωμάτων', 6, 10),
(1612, 'Κβαντική Υπολογιστική', 6, 10),
(1613, 'Μεθοδολογίες Σχεδιασμού Μικροηλεκτρονικών Κυκλωμάτων', 6, 10),
(1671, 'Μικροκυματική Τεχνολογία και Τηλεπισκόπηση', 6, 10),
(1672, 'Οπτοηλεκτρονική και Οπτικές Επικοινωνίες', 6, 10),
(1673, 'Συστήματα Μέσων Μαζικής Επικοινωνίας', 6, 10),
(1641, 'Αριθμητικές Μέθοδοι', 6, 10),
(1642, 'Προηγμένα Θέματα Αλληλεπίδρασης (Προγραμματισμός Κινητών Συσκευών)', 6, 10),
(1643, 'Διοίκηση Έργων', 6, 10),

(1701, 'Δίκτυα Υπολογιστών', 7, 10),
(1702, 'Ηλεκτρονικά Ισχύος', 7, 10),
(1711, 'Συστήματα Αυτομάτου Ελέγχου', 7, 10),
(1712, 'Αισθητήρια και Επεξεργασία Μετρήσεων', 7, 10),
(1713, 'Προγραμματιζόμενοι Λογικοί Ελεγκτές', 7, 10),
(1714, 'Σχεδίαση Επαναπροσδιοριζόμενων Ψηφιακών Συστημάτων (FPGA)', 7, 10),
(1771, 'Τεχνολογίες Ήχου και Εικόνας', 7, 10),
(1741, 'Εισαγωγή στην Αναλυτική των Δεδομένων', 7, 10),
(1742, 'Μηχανική Λογισμικού', 7, 10),
(1743, 'Τεχνολογία Βάσεων Δεδομένων', 7, 10),
(1744, 'Προηγμένες Αρχιτεκτονικές Υπολογιστών και Προγραμματισμός Παράλληλων Συστημάτων', 7, 10),

(1801, 'Ασφάλεια Πληροφοριακών Συστημάτων', 8, 10),
(1802, 'Αρχές και Μέθοδοι Μηχανικής Μάθησης', 8, 10),
(1803, 'Διαδίκτυο των Πραγμάτων', 8, 10),
(1811, 'Εφαρμογές Συστημάτων Αυτομάτου Ελέγχου', 8, 10),
(1812, 'Μετατροπείς Ισχύος', 8, 10),
(1838, 'Εφαρμογές Συστημάτων Ισχύος και ΑΠΕ', 8, 10),
(1839, 'Ηλεκτροκίνηση και Ευφυή Δίκτυα', 8, 10),
(1871, 'Ασύρματα Δίκτυα', 8, 10),
(1872, 'Ειδικά Θέματα Δικτύων (CCNA) 1', 8, 10),
(1873, 'Προηγμένα Θέματα Δικτύων', 8, 10),
(1874, 'Συστήματα Κινητών Επικοινωνιών', 8, 10),
(1898, 'Ελεύθερη Επιλογή Β', 8, 10),
(1841, 'Οργάνωση Δεδομένων και Εξόρυξη Πληροφορίας', 8, 10),
(1842, 'Διαδικτυακές Υπηρεσίες Προστιθέμενης Αξίας', 8, 10),
(1948, 'Ανάπτυξη Ολοκληρωμένων Πληροφοριακών Συστημάτων', 8, 10),

(1911, 'Εφαρμογές Ενσωματωμένων Συστημάτων', 9, 10),
(1912, 'Ρομποτική', 9, 10),
(1913, 'ΑΠΕ και Ευφυή Ηλεκτρικά Δίκτυα', 9, 10),
(1914, 'Απτικές Διεπαφές', 9, 10),
(1915, 'Βιοϊατρική Τεχνολογία', 9, 10),
(1916, 'Συστήματα Μετρήσεων Υποβοηθούμενων από Η/Υ', 9, 10),
(1970, 'Πρακτική Άσκηση', 9, 10),
(1971, 'Ασφάλεια Δικτύων και Επικοινωνιών', 9, 10),
(1972, 'Δικτύωση Καθορισμένη από Λογισμικό', 9, 10),
(1973, 'Ειδικά Θέματα Δικτύων (CCNA) 2', 9, 10),
(1974, 'Δορυφορικές Επικοινωνίες', 9, 10),
(1975, 'Τεχνολογία Πολυμέσων', 9, 10),
(1998, 'Ελεύθερη Επιλογή Α', 9, 10),
(1941, 'Ανάπτυξη Διαδικτυακών Συστημάτων και Εφαρμογών', 9, 10),
(1942, 'Επιχειρησιακή Έρευνα', 9, 10),
(1943, 'Ανάκτηση Πληροφοριών – Μηχανές Αναζήτησης', 9, 10),
(1944, 'Διαχείριση Συστήματος και Υπηρεσιών DBMS', 9, 10),
(1945, 'Ευφυή Συστήματα', 9, 10),
(1946, 'Προηγμένα Θέματα Τεχνητής Νοημοσύνης', 9, 10),
(1947, 'Προηγμένη Μηχανική Μάθηση', 9, 10),
(1949, 'Κατανεμημένα Συστήματα', 9, 10),
(1950, 'Σημασιολογικός Ιστός', 9, 10),
(1969, 'Γραφικά Υπολογιστών', 9, 10);
