...
function QuestionNavigator({ questions, currentIndex, answers, flaggedIds, onJump, className = 'mb-6' }) {
  return (
    <div className={`max-h-28 overflow-y-auto flex flex-wrap gap-1.5 p-1.5 ${className}`}>
      {questions.map((q, i) => {
